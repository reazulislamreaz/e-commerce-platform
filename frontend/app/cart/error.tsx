...
export default function Error({
  ...
  return (
    ...
    >
      <p className="text-[11px] font-semibold uppercase tracking-[.18em] text-[#C9A227]">Bag</p>
      <h1 className="mt-2 text-2xl font-extrabold text-[#111111]">Bag unavailable</h1>
      <p className="mt-3 max-w-md text-sm text-[#555555]">
        We couldn&apos;t load your bag right now. Please try again, or continue shopping.
      </p>
