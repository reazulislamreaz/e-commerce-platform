...
export default function Error({
  ...
  return (
    ...
    >
      <p className="text-[11px] font-semibold uppercase tracking-[.18em] text-[#C9A227]">Error</p>
      <h1 className="mt-2 text-2xl font-extrabold text-[#111111]">Page unavailable</h1>
