...
export default function Error({
  ...
  return (
    ...
    >
      <p className="text-[11px] font-semibold uppercase tracking-[.18em] text-[#C9A227]">Search</p>
      <h1 className="mt-2 text-2xl font-extrabold text-[#111111]">Search unavailable</h1>
      <p className="mt-3 max-w-md text-sm text-[#555555]">
        We couldn&apos;t run search right now. Please try again, or browse the shop by category.
      </p>
