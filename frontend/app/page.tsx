...
const DESKTOP_HERO_SLIDES: DesktopHeroSlide[] = [
  {
    ...
    description: 'Tailored dress shirts and elevated casuals crafted for everyday confidence.',
    href: '/category/men',
    ctaLabel: 'SHOP MEN',
    image: '/images/home/collection-men.webp',
    imageAlt: "Elevate men's blue essentials dress shirt stack",
  },
  {
    id: 'desktop-shirts',
    eyebrow: 'SHIRTS & PRINTS OVERVIEW',
    title: 'SHIRTS EDIT',
    description: 'Plaid, windowpane, floral, and geometric prints for modern movement.',
    href: '/shop?category=Shirts',
    ctaLabel: 'SHOP SHIRTS',
    image: '/images/home/collection-women.webp',
    imageAlt: 'Elevate white peach windowpane check shirt',
  },
  {
...
const collections = [
  ...
  { title: 'SHIRTS\nEDIT', href: '/shop?category=Shirts', image: 'collection-women.webp' },
