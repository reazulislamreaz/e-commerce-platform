  ...
  return (
    <main id="main-content" className="flex-1 bg-[#FAFAFA]">
      ...
      <section className="border-b border-[#E5E7EB] bg-[#FAFAFA]">
        <div className="mx-auto grid max-w-[1400px] lg:grid-cols-2">
          <div className="relative min-h-[320px] overflow-hidden sm:min-h-[420px]">
            ...
            />
            <div className="absolute inset-0 bg-linear-to-t from-[#111111]/80 to-transparent lg:bg-linear-to-r lg:from-transparent lg:to-[#111111]/40" />
          </div>
          <div className="flex flex-col justify-center px-5 py-12 sm:px-7 lg:px-14 lg:py-16">
            ...
            <h1 className="mt-2 text-[clamp(36px,7vw,52px)] font-extrabold leading-[.95] tracking-[-.04em] text-[#111111]">
              ABOUT <span className="text-[#C9A227]">ELEVATE</span>
            </h1>
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-[#555555]">
            ...
            <div className="mt-7 flex flex-wrap gap-2.5">
              ...
              <Link
                href="/contact"
                className="border border-[#cbc6bf] px-5 py-2.5 text-[11px] font-bold uppercase text-[#111111] hover:border-[#C9A227] hover:text-[#C9A227]"
              >
                Contact Us
              </Link>
            </div>
      ...
      <section className="mx-auto max-w-[1400px] px-5 py-12 sm:px-7 sm:py-16">
        ...
        <h2 className="mt-2 text-center text-xl font-bold uppercase tracking-tight text-[#111111] sm:text-2xl">
          The Elevate Standard
        </h2>
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {values.map(({ icon: Icon, title, text }) => (
            <div key={title} className="border-t border-[#E5E7EB] pt-4">
              <Icon className="size-6 text-[#C9A227]" strokeWidth={1.5} />
              <h3 className="mt-3 text-xs font-bold uppercase tracking-wide text-[#111111]">
                {title}
              </h3>
              <p className="mt-2 text-[12px] leading-relaxed text-[#555555]">{text}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="border-t border-[#E5E7EB] bg-white">
        <div className="mx-auto flex max-w-[1400px] flex-col items-start justify-between gap-6 px-5 py-10 sm:flex-row sm:items-center sm:px-7">
          <div>
            ...
            <p className="mt-2 max-w-md text-lg font-bold text-[#111111]">
