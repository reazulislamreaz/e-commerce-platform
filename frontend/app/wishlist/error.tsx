...
export default function Error({
  ...
  return (
    ...
    >
      ...
      <h1 className="mt-2 text-2xl font-extrabold text-[#111111]">Wishlist unavailable</h1>
      <p className="mt-3 max-w-md text-sm text-[#555555]">
        We couldn&apos;t load your wishlist right now. Please try again, or continue shopping.
      </p>
